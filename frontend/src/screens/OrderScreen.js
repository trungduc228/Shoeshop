...
const OrderScreen = (props) => {
    ...
    useEffect(() => {
        ...
        // If order isn't loaded OR make payment OR admin marks as delivered,load order
            ...
            <Col md={8}>
                <ListGroup variant='flush'>
                    <ListGroup.Item>
                        ...
                        <div>
                            <p className='place-order'><strong>Address:</strong>{`${order.shippingAddress.address}`} </p>
                            <p className='place-order'><strong>City:</strong>{`${order.shippingAddress.city}`} </p>
                            <p className='place-order'><strong>postalCode:</strong>{`${order.shippingAddress.postalCode}`} </p>
                        </div>
                        {order.isDelivered ?
